...
Если компания использует инфраструктуру в стороннем облаке, то можно выбрать `Apigee`, если же инфраструктура собственном «железе» (on-premise) или гибридная, то лучше подойдут `Kong`, `Nginx`.
